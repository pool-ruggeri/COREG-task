...
for nblocks = 1:length(blocks)
    if strcmp(blocks{nblocks},'learn')
        ...
        if strcmp(blocks{nblocks},'coreg')
            ...
            dotspeedinc = ; % increase dot's acceleration and deceleration
    ...
    while exitBlock == false
        ...
        if learn == 1
            ...
            Screen('FrameRect',window,recColorOut,centeredRectOut,Out_width);
        else
            % Draw the path to the screen
        ...
        while exitTrial == false
            ...
            if learn == 0 
                ...
                % Draw the path to the screen
                Screen('FrameRect',window,recColorIn,centeredRectIn,In_width);
                ...
                if or (Xdim(end)<= -screenXpixels * rhoIn,Xdim(end)>= screenXpixels * rhoIn)
                ...
                if or (Ydim(end)<= -screenXpixels * rhoIn, Ydim(end)>= screenXpixels * rhoIn)
