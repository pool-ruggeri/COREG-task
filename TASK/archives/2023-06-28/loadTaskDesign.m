...
duration_learn = 5.5*60;  % duration of learning block in seconds
duration_coreg = 5.5*60;  % duration of coreg block in seconds
duration_dysreg = 5.5*60; % duration of dysreg block in seconds
