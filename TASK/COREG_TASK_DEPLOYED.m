...
%% Interaction TASK %%
% Run from a laptop with external screen: 
% -> go to affiche, display on the target screen, slightly close the laptop screen without shutting down the laptop, and run the task 

% Copyright (UNIL-2023-2024)
% Authors:
% 1 - Dr. Paolo Ruggeri (Faculty-SSP, LERB, BEAM LAB)
% 2 - Giuliana Riva Berger (Faculty-SSP, FADO master student)
...
save(['DATA/',filename], '-struct', 'data');
